...
namespace SP23.P03.Web.Features.TrainRoutes
{
    public class TrainRoute
    {
        ...
        public int CoachPrice => (int)(DistanceMiles * 0.5);
        public int FirstClassPrice => (int)(DistanceMiles);
        public int RoomletPrice => (int)(DistanceMiles * 2);
        public int SleeperPrice => (int)(DistanceMiles * 3);
    }
}
